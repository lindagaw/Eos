"""Dataset setting and data loader for STL_10.
Modified from
https://github.com/mingyuliutw/CoGAN/blob/master/cogan_pytorch/src/dataset_stl_10.py
"""
...
class STL_10(data.Dataset):
    ...
    def __init__(self, root, train=True, transform=None, download=False):
        ...
        self.filename = "stl_10_28x28.pkl"
        self.train = train
