...
def get_office_home():
    ...
    office_home_dataset_pseudo_train = datasets.ImageFolder(root="datasets//office_home_pseudo_train",
                               transform=transform)
    office_home_dataset_train = datasets.ImageFolder(root="datasets//office_home_train",
                               transform=transform)
    office_home_dataset_test = datasets.ImageFolder(root="datasets//office_home_test",
                               transform=transform)
