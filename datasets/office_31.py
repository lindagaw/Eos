...
def get_office_31(train, dataset):
    ...
    office_31_data_loader = torch.utils.data.DataLoader(
        dataset=office_31_dataset,
        batch_size=params.batch_size,
        shuffle=False)

    return office_31_data_loader
