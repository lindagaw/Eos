...
def get_office_31():
    ...
    office_31_dataset_pseudo_train = datasets.ImageFolder(root="datasets//office_31_pseudo_train",
                               transform=transform)
    office_31_dataset_train = datasets.ImageFolder(root="datasets//office_31_train",
                               transform=transform)
    office_31_dataset_test = datasets.ImageFolder(root="datasets//office_31_test",
                               transform=transform)
